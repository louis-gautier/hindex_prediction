...
if len(sys.argv) < 6:
    print("Wrong number of arguments! Usage: python", sys.argv[0], "<author-full-embeddings> <model-size> <size-layer1> <size-layers2-3> <dropout-rate>")
    exit()
...
# We define our Graph Convolutional Network architecture
class GCN(torch.nn.Module):
    def __init__(self):
        torch.manual_seed(42)
        super().__init__()
        self.conv1 = GCNConv(nb_features, nb_hidden1)
        self.conv2 = GCNConv(nb_hidden1, nb_hidden2)
